...
export default async function JatekokPage() {
  const posts = await client.fetch(postsByCategoryQuery, { category: "Játék" })
  return (
    <main className="min-h-screen">
      <Header />
      <section className="relative pt-28 pb-12">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-serif font-bold mb-6">Játékok</h1>
          <p className="text-muted-foreground mb-8">Sci-fi játékok hírei és véleményei.</p>
