...
export async function generateMetadata(
  props: { params: Promise<{ year: string; month: string; day: string; slug: string }> }
): Promise<Metadata> {
...
export default async function BlogPostByDatePage(props: { params: Promise<{ year: string; month: string; day: string; slug: string }> }) {
  const { slug } = await props.params
  const post = await getPost(slug)
