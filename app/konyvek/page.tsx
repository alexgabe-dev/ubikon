...
export const metadata: Metadata = {
  title: "Könyvek",
  description: "Sci-fi könyvek kritikái és esszéi.",
  alternates: { canonical: `${siteUrl}/konyvek` },
}

export const revalidate = 60

export default async function KonyvekPage() {
  const posts = await client.fetch(postsByCategoryQuery, { category: "Könyv" })
  return (
    <main className="min-h-screen">
      <Header />
      <section className="relative pt-28 pb-12">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-serif font-bold mb-6">Könyvek</h1>
          <p className="text-muted-foreground mb-8">Sci-fi könyvek kritikái és esszéi.</p>
