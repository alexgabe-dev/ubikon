...
export const metadata: Metadata = {
  title: "Sorozatok",
  description: "Sci-fi sorozatok kritikái és ajánlók.",
  alternates: { canonical: `${siteUrl}/sorozatok` },
}

export const revalidate = 60

export default async function SorozatokPage() {
  const posts = await client.fetch(postsByCategoryQuery, { category: "Sorozat" })
  return (
    <main className="min-h-screen">
      <Header />
      <section className="relative pt-28 pb-12">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-serif font-bold mb-6">Sorozatok</h1>
          <p className="text-muted-foreground mb-8">Sci-fi sorozatok kritikái és ajánlók.</p>
